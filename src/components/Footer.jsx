/**
 * Футер сайта — нижняя часть с навигацией, контактами, рассылкой и копирайтом.
 *
 * @component
 ...
 * - Быстрые ссылки (о нас, контакты, поддержка)
 * - Контактная информация (адрес, телефон, email)
 * - Подписка на рассылку
 * - Копирайт и иконки способов оплаты
 *
 * Поддерживает мультиязычный интерфейс через объект `translations`.
...
const Footer = ({ language }) => {
     ...
     *
     * @param {string} key - Ключ локализации (например, 'about', 'contact')
    ...
    return (
        <footer className="bg-gray-900 text-white" role="contentinfo">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 mb-4">
                            {language === 'ru'
                                ? 'Лучший интернет-магазин электроники и товаров для дома. Качественные товары по лучшим ценам с доставкой по всей России.'
                ...
                {/* Нижняя панель: копирайт и способы оплаты */}
                <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-400 text-sm" role="copyright">
